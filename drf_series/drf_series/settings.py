"""
Django settings for drf_series project.
...
SECRET_KEY = 'django-insecure-eh^=upc+l63rs^h0f$2h5pl=8$mukecy)#)o9jg(t=9qvg=&^l'
...
WSGI_APPLICATION = 'drf_series.wsgi.application'
